...
f2().then(v=>console.log(v),e=>console.log(e)); // error ok
...
f4().then(v=>{console.log(v)}).catch(e=>{console.log(e)}); // error ...
...
f5().then(v=>{console.log(v)}); // async test
// 第二种方法：
async function f6() {
  await Promise.reject('出错了')
...
f6().then(v => console.log(v))// 出错了 // hello world
