...
// 新写法
const instanceNew=Reflect.construct(Greeting,['lee']);
...
// 新写法
const youngestto = Reflect.apply(Math.min, Math, ages);
const oldestto = Reflect.apply(Math.max, Math, ages);
const typeto = Reflect.apply(Object.prototype.toString, youngestto, []);
